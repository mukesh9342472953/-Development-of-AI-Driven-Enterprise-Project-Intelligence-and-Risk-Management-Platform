...
page_header(
    "Non-IT Business Project & Dataset Intelligence Analysis",
    "Comprehensive enterprise dataset telemetry across 200,000 operational records, Random Forest model statistics, and project analytics."
)
...
st.subheader("Business Telemetry & System Scale")
...
with k4:
    st.markdown(f"""
    <div class="metric-card">
        <div class="metric-card-title">Relevant Non-IT Records</div>        <div class="metric-card-value" style="color:#fbbf24;">{meta['non_it_count']:,}</div>
